...
RequiredAssemblies = if($PSEdition -eq 'Desktop') {@('lib\net45\Microsoft.ApplicationInsights.dll')} else {$null}
...
PrivateData = @{
    Messages = @{
        NotInitialized = 'Call Initialize-AiLogger before running other cmdlets.'
    }
    PSData = @{
        ...
        ProjectUri = 'https://github.com/jformacek/AiLogging'
